...
<template>
    <div class="default-main">
        <el-row class="nav">
            ...
            <el-col :span="1.2" style="margin-right: 100px;">
                <el-tooltip content="显示24小时内的所有数据" placement="top">
                    <el-button type="primary" color="#626aef" plain class="FIC141" @click="dialogVisible = true">
                        历史数据
                    </el-button>
                </el-tooltip>
            </el-col>
            <el-col :span="1.2" style="margin-right: 10px;">
                <el-tooltip content="跳转到测试页" placement="top">
                    <el-button type="primary" color="#626aef" plain class="testbtn" @click="testClick()">
                        测试按钮
                    </el-button>
                </el-tooltip>
            </el-col>
            ...
            <el-col :span="1.2" style="margin-right: 10px;">
                <el-tooltip content="弹出对话框" placement="top">
                    <el-button type="primary" color="#626aef" plain class="testbtn" @click="testClick2()">
                        弹出对话框
                    </el-button>
                </el-tooltip>
            </el-col>
        ...
        <testPage v-if="devValue === 'Option3'"></testPage>
        <empty v-if="devValue === 'Option4'"></empty>
        ...
        <el-dialog v-model="dialogVisible" width="48%" draggable @open="open()" @close="close()">
            ...
            <template #footer>
                <span class="dialog-footer">
                    <el-autocomplete v-model="point" :fetch-suggestions="querySearch" :trigger-on-focus="true" clearable
                        class="inline-input w-25" placeholder="Please Input" />
...
import testPage from '../../new.vue'
import empty from '../options5/index.vue'
...
watchEffect(() => {
    ...
    } else if (freqValue.value === 'Option2' && timestamps.value && timestampsischange) { //装置2同理
        timestampsischange = false
