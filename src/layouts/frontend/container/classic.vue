 ...
 * @LastEditTime: 2022-10-27 20:01:07
 * @LastEditors: zwj
-->
<template>
...
import Main from '/@/layouts/frontend/router-view/main.vue'
import CloseFullScreen from '/@/layouts/frontend/components/closeFullScreen.vue'
